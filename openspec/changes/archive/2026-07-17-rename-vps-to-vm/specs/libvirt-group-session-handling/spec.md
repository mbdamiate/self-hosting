...
The local VM setup script SHALL verify that both `libvirt` and `kvm` are active in the current process before it performs unprivileged libvirt or VM-creation operations.
