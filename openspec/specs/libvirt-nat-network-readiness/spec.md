...
Ensure the default libvirt NAT network is defined, active, and set to autostart before VM creation in NAT-mode setup, while leaving bridged-mode network configuration untouched.
